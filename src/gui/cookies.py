...
from PyQt5 import QtCore, QtNetwork, QtQml
...
class CookieManager(QtCore.QObject):
    ...
    def setCookie(self, f):
        ...
        # reply = self.network_manager.get(QtNetwork.QNetworkRequest(QtCore.QUrl("")))    
...
class NetworkManagerFactory(QtQml.QQmlNetworkAccessManagerFactory):
